...
<control type="group">
    ...
    <control type="label">
        ...
        <align>center</align>
        <textcolor>FFFFFFFF</textcolor>
        <label>[B]$ADDON[script.royfelott 32452][/B]</label>
    </control>
    <control type="label">
        <scroll>false</scroll>
        <posx>60</posx>
        ...
        <label>$ADDON[script.royfelott 32453]</label>
    </control>
</control>
...
<control type="group">
    ...
    <control type="label">
        ...
        <align>center</align>
        <textcolor>FFFFFFFF</textcolor>
        <label>[B]$ADDON[script.royfelott 32454][/B]</label>
    </control>
    <control type="label">
        <scroll>false</scroll>
        <posx>60</posx>
        ...
        <align>center</align>
        <textcolor>FFCCCCCC</textcolor>
        <label>$ADDON[script.royfelott 32455]</label>
    </control>
</control>
