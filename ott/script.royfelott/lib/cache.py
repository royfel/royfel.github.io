...
class KodiCacheManager(object):
    ...
    recRFRange = "4-10"
    template = None
    orig_tpl_path = os.path.join(ADDON.getAddonInfo('path'), "royfel_cache_template.xml")
    custom_tpl_path = "special://profile/royfel_cache_template.xml"
    ...
    def getTemplate(self):
        ...
        DEBUG_LOG("Custom royfel_cache_template.xml not found, using default")
