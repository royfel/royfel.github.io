...
class Settings(object):
    SETTINGS = {
        'main': (
            T(32000, 'Main'), (
                BoolSetting('kiosk.mode', T(32043, 'Start ROYFEL On Player Startup'), False),
                OptionsSetting(
        ...
        'player': (
            T(32940, 'Player UI'), (
                BoolSetting('player_official', T(33045, 'Behave like official ROYFEL clients'), True).description(
                    T(33046, '')),
        ...
        'system': (
            T(33600, 'System'), (
                ...
                BoolSetting('exit_default_is_quit', T(32965, 'Start ROYFEL On Player Startup'), False)
                ...
                OptionsSetting(
                    ...
                    [('none', T(32702, 'Nothing')), ('restart', T(33071, 'Restart ROYFEL'))]
