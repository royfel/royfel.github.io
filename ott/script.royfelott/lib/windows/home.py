...
class HomeWindow(kodigui.BaseWindow, util.CronReceiver, SpoilersMixin):
    ...
    HUBMAP = {
        ...
        # This hub can be enabled in the settings so ROYFEL behaves like any other ROYFEL OTT client.
        ...
        # This is a virtual hub and it appears when the library recommendation is customized in ROYFEL and
        ...
        #'home.playlists': {'index': 9}, # No other ROYFEL home screen shows playlists so removing it from here
    ...
    def checkPlexDirectHosts(self, servers, source="stored", *args, **kwargs):
        ...
        for server in servers:
            # only check stored or myroyfel servers
            ...
            # server locally, skip royfel.direct handling
            if ((util.addonSettings.honorPlextvDnsrebind and not server.dnsRebindingProtection) or
                ...
                util.DEBUG_LOG("Ignoring DNS handling for royfel.direct connections of: {}", server)
                continue
        ...
        # there are situations where the myROYFELManager's resources are ready earlier than
    ...
    def confirmExit(self):
        ...
        button = optionsdialog.show(
            ...
            T(32335, 'Are you ready to exit ROYFEL OTT?'),
